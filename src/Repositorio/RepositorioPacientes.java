...
public class RepositorioPacientes {
    ...
    public static void CargaDatosPaciente() throws DiaInvalido, MesInvalido{
        ...
        repositorioPacientes.add(new Paciente(fechanac,"Enrique",01,'H',20,614120,21,"gay","Crack"));
        repositorioPacientes.add(new Paciente(fechanac,"cripsinm",01,'H',20,614120,21,"gay","Crack"));
