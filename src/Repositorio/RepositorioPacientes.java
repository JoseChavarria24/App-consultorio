...
public class RepositorioPacientes {
    ...
    public static void CargaDatosPaciente( ) throws DiaInvalido, MesInvalido{
        ...
        repositorioPacientes.add(new Paciente(fechia,"Enrique Rodriguez Guillen",01,"M",21,61412036,1,"Buda","Programador Senior"));
        repositorioPacientes.add(new Paciente(fechia,"Jose Santos Chavarria Valdez",01,"M",21,61412036,1,"Buda","Programador Senior"));
        repositorioPacientes.add(new Paciente(fechia,"Lertín Gómez ",01,"M",21,61412036,1,"Buda","Programador Senior"));
        repositorioPacientes.add(new Paciente(fechia,"Memo ochoa",01,"M",21,61412036,1,"Buda","Programador Senior"));
        repositorioPacientes.add(new Paciente(fechia,"Chocó perez",01,"M",21,61412036,1,"Buda","Programador Senior"));
        repositorioPacientes.add(new Paciente(fechia,"Jhon Cena",01,"M",21,61412036,1,"Buda","Programador Senior"));
